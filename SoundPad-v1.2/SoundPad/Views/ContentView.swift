...
struct ContentView: View {
    ...
    @State private var engList: [String] = ["Search for sound..."]
    @State private var rusList: [String] = ["Поиск звука..."]
        ...
        ZStack {
            ...
            GeometryReader { geometry in
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    TextField(texts[0], text: $searchText)
...
struct SoundRowView: View {
    ...
    @Environment(\.modelContext) var modelContext
    @State private var engList: [String] = ["Delete", "Assign for key"]
    @State private var rusList: [String] = ["Удалить", "Назначить на клавишу"]
        ...
        HStack {
            ...
            Menu {
                Button(role: .destructive) {
                    ...
                    Label(texts[0], systemImage: "trash")
                }
                
                Button() {
                    selectedSound = sound
                } label: {
                    Label(texts[1], systemImage: "keyboard")
                }
